...
while true do
    ...
    mon.setCursorPos(1,4)
    mon.setTextColor(colors.white)
    mon.write("Reactor Battery: ")
    mon.setTextColor(colors.red)
    --As of February 11th 2021.
    --BiggerReactors displayes energy stored in persentage rather then actual RF amount.
    --This is due to the internal battery scaling in this new "mod clone"
